...
@Component({
  selector: 'app-search-venue-admins',
  templateUrl: './search-venue-admins.component.html',
  styleUrls: ['./search-venue-admins.component.less']
})
export class SearchVenueAdminsComponent implements OnInit {
  ...
  constructor(
    ...
    this.searchForm = new FormGroup({
      ...
      assignedVenue: new FormControl("any")
    })
  ...
  public async searchAdmins(): Promise<void> {
    try {
      ...
      const request: any = await this.http.post(environment.api + '/api/admin/accounts/venues/get-accounts', {
        ...
        venueId: this.searchForm.value.assignedVenue && this.searchForm.value.assignedVenue !== 'any' ? this.searchForm.value.assignedVenue : null
      }).toPromise();
