...
@Component({
  selector: 'app-search-influencer-team',
  templateUrl: './search-influencer-team.component.html',
  styleUrls: ['./search-influencer-team.component.less']
})
export class SearchInfluencerTeamComponent implements OnInit {
