...
@Component({
  selector: 'app-my-influencer-posts',
  templateUrl: './my-influencer-posts.component.html',
  styleUrls: ['./my-influencer-posts.component.less']
})
export class MyInfluencerPostsComponent implements OnInit {
  ...
  private async loadData(): Promise<void> {
    try {
      const request: any = await this.http.post(environment.api + '/api/admin/influencer-posts/get-influencer-posts', {
