...
@Component({
  selector: 'app-floot-influencer-edit-post',
  templateUrl: './floot-influencer-edit-post.component.html',
  styleUrls: ['./floot-influencer-edit-post.component.less']
})
export class FlootInfluencerEditPostComponent implements OnInit {
