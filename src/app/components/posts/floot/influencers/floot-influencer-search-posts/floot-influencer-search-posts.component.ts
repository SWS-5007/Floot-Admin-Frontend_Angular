...
@Component({
  selector: 'app-floot-influencer-search-posts',
  templateUrl: './floot-influencer-search-posts.component.html',
  styleUrls: ['./floot-influencer-search-posts.component.less']
})
export class FlootInfluencerSearchPostsComponent implements OnInit {
  ...
  constructor(
    ...
    this.searchForm = new FormGroup({
      ...
      influencerId: new FormControl(null, {
        updateOn: "change",
      }),
    })
  }
  ...
  public async searchPosts(): Promise<void> {
    try {
      ...
      const request: any = await this.http.post(environment.api + '/api/admin/influencer-posts/get-posts', {
        ...
        influencerId: this.searchForm.value.influencerId ? this.searchForm.value.influencerId : null
      }).toPromise();
