...
@Component({
  selector: 'app-search-supplier-team',
  templateUrl: './search-supplier-team.component.html',
  styleUrls: ['./search-supplier-team.component.less']
})
export class SearchSupplierTeamComponent implements OnInit {
