...
@Component({
  selector: 'app-search-influencer-admins',
  templateUrl: './search-influencer-admins.component.html',
  styleUrls: ['./search-influencer-admins.component.less']
})
export class SearchInfluencerAdminsComponent implements OnInit {
  ...
  constructor(
    ...
    this.searchForm = new FormGroup({
      ...
      assignedInfluencer: new FormControl("any")
    })
  ...
  private async loadData(): Promise<void> {
    try {
      const request: any = await this.http.post(environment.api + '/api/admin/accounts/influencers/get-accounts', {
  ...
  public async searchAdmins(): Promise<void> {
    try {
      ...
      const request: any = await this.http.post(environment.api + '/api/admin/accounts/influencers/get-accounts', {
        ...
        influencerId: this.searchForm.value.assignedInfluencer && this.searchForm.value.assignedInfluencer !== 'any' ? this.searchForm.value.assignedInfluencer : null
      }).toPromise();
